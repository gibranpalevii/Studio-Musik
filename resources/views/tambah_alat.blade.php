...
<head>
    ...
    <title>Tambah Alat - Gayza Studio</title>
...
<div class="d-flex">
    ...
    <div class="col-md-10 p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold">Tambah Alat Musik</h3>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow-lg p-3">
                    <div class="card-body">
                        <form action="{{ url('/alat/store') }}" method="POST" enctype="multipart/form-data">
                            @csrf 
                            
                            <div class="mb-4">
                                <label class="form-label">Nama Alat</label>
                                <input type="text" name="nama_alat" class="form-control" placeholder="Contoh: Gitar Listrik Yamaha" required>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="harga_sewa" class="form-control" placeholder="50000" required>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
