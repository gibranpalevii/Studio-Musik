...
<head>
    ...
    <title>Edit Pelanggan - Gayza Studio</title>
...
<div class="d-flex">
    <div class="sidebar col-md-2 d-none d-md-block p-4">
        ...
        <div class="nav flex-column">
            ...
            <small class="text-muted text-uppercase fw-bold mt-4 mb-2" style="font-size:10px;">Admin</small>
    ...
    <div class="col-md-10 p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold">Edit Data Pelanggan</h3>
                ...
                <div class="card shadow-lg p-3">
                    <div class="card-body">
                        <form action="{{ url('/pelanggan/update/'.$pelanggan->id_pelanggan) }}" method="POST">
                            @csrf
                            {{-- Saya tambahkan method PUT agar sesuai standar Laravel, 
                                 namun jika route Anda POST biasa, ini tidak akan mengganggu --}}
                            @method('PUT') 
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="no_hp" class="form-control" value="{{ $pelanggan->no_hp }}" required>
                            </div>
